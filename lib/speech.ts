...
const VOCAB: Vocab[] = [
  ...
  { en: 'Harpic', hi: 'हार्पिक', bn: 'হারপিক' },
  { en: 'Lizol', hi: 'लाइज़ोल', bn: 'লাইজল' },
  { en: 'Colin', hi: 'कॉलिन', bn: 'কলিন' },
  { en: 'Tide', hi: 'टाइड', bn: 'টাইড' },
  { en: 'Nirma', hi: 'निरमा', bn: 'নিরমা' },
  { en: 'Pears', hi: 'पियर्स', bn: 'পিয়ার্স' },
  { en: 'Santoor', hi: 'संतूर', bn: 'সন্তুর' },
  { en: 'Dove', hi: 'डव', bn: 'ডাভ' },
  { en: 'Nivea', hi: 'निविया', bn: 'নিভিয়া' },
  { en: 'Himalaya', hi: 'हिमालया', bn: 'হিমালয়া' },
  { en: 'Patanjali', hi: 'पतंजलि', bn: 'পতঞ্জলি' },
  { en: 'Vicks', hi: 'विक्स', bn: 'ভিক্স' },
  { en: 'Boroline', hi: 'बोरोलीन', bn: 'বোরোলিন' },
  { en: 'Parachute', hi: 'पैराशूट', bn: 'প্যারাস্যুট' },
  { en: 'Closeup', hi: 'क्लोज़अप', bn: 'ক্লোজআপ', roman: ['close up', 'close-up'] },
  { en: 'Sensodyne', hi: 'सेंसोडाइन', bn: 'সেনসোডাইন' },
  { en: 'Mortein', hi: 'मॉर्टीन', bn: 'মর্টিন' },
  { en: 'Good Knight', hi: 'गुड नाइट', bn: 'গুড নাইট', roman: ['goodknight'] },
  { en: 'Odonil', hi: 'ओडोनिल', bn: 'ওডোনিল' },
  { en: 'Nestle', hi: 'नेस्ले', bn: 'নেসলে', roman: ['nestlé'] },
  { en: 'Kissan', hi: 'किसान', bn: 'কিষাণ' },
  { en: 'Sunfeast', hi: 'सनफीस्ट', bn: 'সানফিস্ট' },
  { en: 'Everest', hi: 'एवरेस्ट', bn: 'এভারেস্ট' },
  { en: 'MDH', hi: 'एमडीएच', bn: 'এমডিএইচ' },
  { en: 'Saffola', hi: 'सफोला', bn: 'সাফোলা' },
  { en: 'Mother Dairy', hi: 'मदर डेयरी', bn: 'মাদার ডেয়ারি' },
  { en: 'Bisleri', hi: 'बिसलेरी', bn: 'বিসলেরি' },
  { en: 'Pepsi', hi: 'पेप्सी', bn: 'পেপসি' },
  { en: 'Sprite', hi: 'स्प्राइट', bn: 'স্প্রাইট' },
  // THE WORDS AROUND A BRAND ON A PACKET. A name read off a photo is brand plus
  // these ("Dettol Handwash Original"), and each is spelt the way it is said,
  // so the whole name reads right instead of being spelt out letter by letter.
  { en: 'Handwash', hi: 'हैंडवॉश', bn: 'হ্যান্ডওয়াশ', roman: ['hand wash'] },
  { en: 'Bodywash', hi: 'बॉडीवॉश', bn: 'বডিওয়াশ', roman: ['body wash'] },
  { en: 'Facewash', hi: 'फेसवॉश', bn: 'ফেসওয়াশ', roman: ['face wash'] },
  { en: 'Dishwash', hi: 'डिशवॉश', bn: 'ডিশওয়াশ', roman: ['dish wash'] },
  { en: 'Wash', hi: 'वॉश', bn: 'ওয়াশ' },
  { en: 'Original', hi: 'ओरिजिनल', bn: 'অরিজিনাল' },
  { en: 'Liquid', hi: 'लिक्विड', bn: 'লিকুইড' },
  { en: 'Shampoo', hi: 'शैम्पू', bn: 'শ্যাম্পু' },
  { en: 'Toothpaste', hi: 'टूथपेस्ट', bn: 'টুথপেস্ট' },
  { en: 'Cream', hi: 'क्रीम', bn: 'ক্রিম' },
  { en: 'Lotion', hi: 'लोशन', bn: 'লোশন' },
  { en: 'Gel', hi: 'जेल', bn: 'জেল' },
  { en: 'Cleaner', hi: 'क्लीनर', bn: 'ক্লিনার' },
  { en: 'Refill', hi: 'रिफिल', bn: 'রিফিল' },
  { en: 'Noodles', hi: 'नूडल्स', bn: 'নুডলস', roman: ['noodle'] },
  { en: 'Chips', hi: 'चिप्स', bn: 'চিপস' },
  { en: 'Masala', hi: 'मसाला', bn: 'মশলা' },
  { en: 'Juice', hi: 'जूस', bn: 'জুস' },
  { en: 'Classic', hi: 'क्लासिक', bn: 'ক্লাসিক' },
  { en: 'Gold', hi: 'गोल्ड', bn: 'গোল্ড' },
  { en: 'Premium', hi: 'प्रीमियम', bn: 'প্রিমিয়াম' },
  { en: 'Fresh', hi: 'फ्रेश', bn: 'ফ্রেশ' },
  { en: 'Lemon', hi: 'नींबू', bn: 'লেবু' },
  { en: 'Neem', hi: 'नीम', bn: 'নিম' },
  { en: 'Power', hi: 'पावर', bn: 'পাওয়ার' },
  { en: 'Plus', hi: 'प्लस', bn: 'প্লাস' },
  { en: 'Easy', hi: 'ईज़ी', bn: 'ইজি' },
  { en: 'Strong', hi: 'स्ट्रॉन्ग', bn: 'স্ট্রং' },
  { en: 'Floor', hi: 'फ्लोर', bn: 'ফ্লোর' },
  { en: 'Minute', hi: 'मिनट', bn: 'মিনিট', roman: ['minutes'] },
  { en: 'Instant', hi: 'इंस्टेंट', bn: 'ইনস্ট্যান্ট' },
  { en: 'Active', hi: 'एक्टिव', bn: 'অ্যাক্টিভ' },
  { en: 'Herbal', hi: 'हर्बल', bn: 'হারবাল' },
  { en: 'Total', hi: 'टोटल', bn: 'টোটাল' },
  { en: 'Pure', hi: 'प्योर', bn: 'পিওর' },
  { en: 'Natural', hi: 'नेचुरल', bn: 'ন্যাচারাল' },
];
