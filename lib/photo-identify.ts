...
- nameBn and nameHi: the same name written in Bengali script and in Hindi (Devanagari) script, the way Indian packets, shop boards and adverts write it: brands are transliterated as they sound (Dettol → ডেটল / डेटॉल, Surf Excel → সার্ফ এক্সেল / सर्फ एक्सेल), common words are written as people say them (Handwash → হ্যান্ডওয়াশ / हैंडवॉश, Mustard Oil → সরষের তেল / सरसों तेल).
